...
@section('content')
    ...
    <div class="mb-3"><a href="{{ route('admin.manure.edit', $manure->id) }}" class="btn btn-success">Редактировать</a>
    </div>

    <form action="{{ route('admin.manure.delete', $manure->id) }}" method="post" class="mb-3">
        @csrf
        @method('delete')
    ...
    <div><a href="{{ route('admin.manure.index') }}" class="btn btn-primary">К списку удобрений</a></div>
